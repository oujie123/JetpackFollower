...
public final class TecentUtil {
    public static final String secretId = "AKID1kqbAyawLBlI355rlEfeDU26nRZ8hLE7i6rc";
    public static final String secretKey = "adwqfosyql7pfbEvfpa65ycno1fnbr3ltpk3nusy";
